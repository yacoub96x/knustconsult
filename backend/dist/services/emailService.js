...
if (smtpHost && smtpUser && smtpPass) {
    ...
    etherealInitPromise = nodemailer_1.default
        .createTestAccount()
        .then((account) => {
        transporter = nodemailer_1.default.createTransport({
...
function getKnustHtmlTemplate(title, contentHtml) {
    return `
<!DOCTYPE html>
<html>
<head>
...
exports.emailService = {
     ...
     */
    async sendBookingRequest(details) {
        ...
        const html = getKnustHtmlTemplate(subject, `
     ...
     */
    async sendBookingApproved(details) {
     ...
     */
    async sendBookingRejected(details) {
     ...
     */
    async sendBookingCancellation(details, cancelledByRole) {
